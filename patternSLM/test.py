...
sdk = TLCameraSDK()
available_camera = sdk.discover_available_cameras()
camera = sdk.open_camera(available_camera[0])

camera.exposure_time_us = 100  # set exposure to 11 ms
camera.frames_per_trigger_zero_for_unlimited = 0  # start camera in continuous mode (if 0)
camera.image_poll_timeout_ms = 100  # polling timeout
