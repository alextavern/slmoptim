...
from ..zeluxPy import download as down
...
class measTM:
    ...
    def get(self):
        ...
        download_thread = down.FrameAcquisitionThread(camera_thread.camera,
                                                      download_frame_event,
                                                      upload_pattern_event,
                                                      stop_all_event)
